...
def show_x_error_chart(count):
    ...
    if count < 4:
        stats.plot_covariance_ellipse(
            (0, 0), ellipse=pos_ellipse, variance=sigma)
    ...
    if count == 3:
        ...
        stats.plot_covariance_ellipse(
            (5, 5), ellipse=pos_ellipse, variance=sigma)
        stats.plot_covariance_ellipse((0, 0), ellipse=vel_ellipse, variance=sigma,
                                      edgecolor='r')
    ...
    if count == 4:
        ...
        stats.plot_covariance_ellipse(
            (0, 0), ellipse=pos_ellipse, variance=sigma, alpha=0.25)
        stats.plot_covariance_ellipse(
            (5, 5), ellipse=pos_ellipse, variance=sigma, alpha=0.25)
...
def show_x_with_unobserved():
    ...
    stats.plot_covariance_ellipse(
        (2, 2), cov=cov, variance=sigma, axis_equal=False)
    ...
    stats.plot_covariance_ellipse(
        (1, 1), ellipse=e, variance=sigma, axis_equal=False)
    stats.plot_covariance_ellipse(
        (2, 1), ellipse=e, variance=sigma, axis_equal=False)
    stats.plot_covariance_ellipse(
        (3, 1), ellipse=e, variance=sigma, axis_equal=False)

    # plot intersection circle
    isct = Ellipse(xy=(2, 2), width=.2, height=1.2,
